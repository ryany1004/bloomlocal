...
class ProductModelSimpleSerializer(serializers.ModelSerializer):
    ...
    def get_analytics(self, product):
        data = {}
        if hasattr(product, 'product_add_to_cart_count'):
            data['product_add_to_cart_count'] = product.product_add_to_cart_count
