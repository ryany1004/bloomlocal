        ...
        <div
          ...
          class="Password__toggle">
            <button
              ...
              <svg v-if="this.$data.show_password" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
<script>
  ...
  export default {
    ...
    methods: {
      togglePassword () {
        if (this.$data.show_password) {
          this.$emit('hide')
          this.$data.show_password = false
        } else {
          this.$emit('show')
          this.$data.show_password = true
        }
      },
    ...
    computed: {
       ...
       * based on the local show_password data or the showPassword prop
       */
      inputType () {
        return this.$data.show_password || this.showPassword ? 'text' : 'password'
      },
      showPasswordLabel () {
        return this.$data.show_password || this.showPassword ? this.labelHide : this.labelShow
      }
    },
    watch: {
      value (newValue) {
