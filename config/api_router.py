...
urlpatterns += [
    ...
    path('analytics/product-view-channels/', analytics_apis.ProductViewChannelsData.as_view(),
         name="product-view-channels-report"),
    path('analytics/storefront-view/', analytics_apis.StorefrontViewData.as_view(), name="storefront-view-report"),
    path('analytics/product-added-to-cart/', analytics_apis.ProductAddedToCartData.as_view(),
         name="product-added-to-cart-report"),
    ...
    path('analytics/popular-products-sale-and-view/', analytics_apis.ShopPopularProductsData.as_view(),
         name="shop-popular-products-report"),
    ...
    path('analytics/top-products-add-to-cart/', analytics_apis.TopProductsAddToCart.as_view(),
         name="top-products-add-to-cart"),
]
