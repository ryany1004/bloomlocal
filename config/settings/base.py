...
MIGRATION_MODULES = {"sites": "bloom.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "DIRS": [str(APPS_DIR / "templates"), str(APPS_DIR / "users/templates")],
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "bloom.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "bloom.users.adapters.SocialAccountAdapter"
...
SEARCH_DISTANCE_IN_KM = env.float('SEARCH_DISTANCE_IN_KM', 20)
...
ACCOUNT_EMAIL_CONFIRMATION_ANONYMOUS_REDIRECT_URL = 'https://www.bloomlocal.ca'
ACCOUNT_EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = 'https://www.bloomlocal.ca'
